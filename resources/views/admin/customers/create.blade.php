...
<form action="{{ route('customers.store') }}" method="POST">
  ...
  <div class="mb-3 {{ $errors->has('fullName') ? 'has-error' : ''}}" >
    ...
    <input type="text" class="form-control" id="name" value="{{ old('fullName') }}" name="fullName">
  ...
  <div class="mb-3 {{ $errors->has('pass') ? 'has-error' : ''}}">
    ...
    <input type="text" class="form-control" id="pwd" value="{{ old('pass') }}" name="pass">
    @if( $errors->has('pass'))
    <span class="help-block">
  ...
  <div class="mb-3 {{ $errors->has('address') ? 'has-error' : ''}}">
    ...
    <input type="text" class="form-control" id="adr" value="{{ old('address')}}" name="address">
